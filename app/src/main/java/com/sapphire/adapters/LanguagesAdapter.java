...
public class LanguagesAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (data.getName().equals("en")) {
            text_name.setText(Sapphire.getInstance().getResources().getString(R.string.english));
            language_ico.setImageResource(R.drawable.english);
        } else if (data.getName().equals("fr")) {
            text_name.setText(Sapphire.getInstance().getResources().getString(R.string.french));
