...
public class MeetingDeleteAction extends AsyncTask{

    public interface RequestMeetingDelete {
    ...
    public MeetingDeleteAction(Context context, String id) {
    ...
    protected Object doInBackground(Object... arg0) {
        ...
        String urlstring = Environment.SERVER + Environment.MeetingsURL + "?model%5B%5D="+id;
    ...
    protected void onPostExecute(Object o) {
        ...
        if(mContext!=null) {
            ((RequestMeetingDelete) mContext).onRequestMeetingDelete(resultData);
        }
    }
}
