...
public class PerformanceDeleteAction extends AsyncTask{

    public interface RequestPerformanceDelete {
    ...
    public PerformanceDeleteAction(Context context, String id) {
    ...
    protected void onPostExecute(Object o) {
        ...
        if(mContext!=null) {
            ((RequestPerformanceDelete) mContext).onRequestPerformanceDelete(resultData);
        }
    }
}
