...
public class InvestigationDeleteAction extends AsyncTask{

    public interface RequestInvestigationDelete {
    ...
    public InvestigationDeleteAction(Context context, String id) {
    ...
    protected Object doInBackground(Object... arg0) {
        ...
        String urlstring = Environment.SERVER + Environment.InvestigationsURL + "?model%5B%5D="+id;
    ...
    protected void onPostExecute(Object o) {
        ...
        if(mContext!=null) {
            ((RequestInvestigationDelete) mContext).onRequestInvestigationDelete(resultData);
        }
    }
}
