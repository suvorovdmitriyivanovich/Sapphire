...
public class InvestigationItemDeleteAction extends AsyncTask{

    public interface RequestInvestigationItemDelete {
    ...
    public InvestigationItemDeleteAction(Context context, String id) {
    ...
    protected Object doInBackground(Object... arg0) {
        ...
        String urlstring = Environment.SERVER + Environment.InvestigationItemsURL + "?model%5B%5D="+id;
    ...
    protected void onPostExecute(Object o) {
        ...
        if(mContext!=null) {
            ((RequestInvestigationItemDelete) mContext).onRequestInvestigationItemDelete(resultData);
        }
    }
}
