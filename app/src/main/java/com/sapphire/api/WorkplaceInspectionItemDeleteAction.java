...
public class WorkplaceInspectionItemDeleteAction extends AsyncTask{
    ...
    public interface RequestWorkplaceInspectionItemDelete {
    ...
    public WorkplaceInspectionItemDeleteAction(Context context, String workplaceInspectionItemId) {
    ...
    protected Object doInBackground(Object... arg0) {
        ...
        String urlstring = Environment.SERVER + Environment.WorkplaceInspectionItemsURL + "?model%5B%5D="+workplaceInspectionItemId;
    ...
    protected void onPostExecute(Object o) {
        ...
        if(mContext!=null) {
            ((RequestWorkplaceInspectionItemDelete) mContext).onRequestWorkplaceInspectionItemDelete(resultData);
        }
    }
}
