...
public class NetRequests {
    ...
    public String SendRequestCommon(String request, String json, int timout, boolean returnerror, String method, String authToken) {
        ...
        try {
            ...
            //    rez = "400";
                ...
                rez = Dealerpilothr.getInstance().getResources().getString(R.string.text_unauthorized);
            } else {
            ...
            if (returnerror) {
                ...
                if (rez.indexOf("after") != -1) {
                    rez = Dealerpilothr.getInstance().getResources().getString(R.string.text_timeaut);
                }
            }
        }
    ...
    public boolean isOnline(boolean checkGoogle) {
        ...
        ConnectivityManager cm =
                (ConnectivityManager) Dealerpilothr.getInstance().getSystemService(Context.CONNECTIVITY_SERVICE);
