...
import com.dealerpilothr.activities.course.CourseActivity;
import com.dealerpilothr.activities.course.QuizActivity;
import com.dealerpilothr.activities.meeting.MeetingActivity;
import com.dealerpilothr.activities.policy.PdfActivity;
import com.dealerpilothr.activities.workplaceInspection.WorkplaceInspectionActivity;
import com.dealerpilothr.adapters.CoursesAdapter;
import com.dealerpilothr.adapters.MembersAdapter;
import com.dealerpilothr.adapters.PoliciesAdapter;
import com.dealerpilothr.api.CoursesAction;
import com.dealerpilothr.api.CurrentOrganizationStructuresAction;
...
import com.dealerpilothr.api.PunchesCategoriesAction;
        ...
        br = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (putreqwest.equals("updateleftmenu")) {
                    ...
                    Intent intnt = new Intent(Dealerpilothr.getInstance(), LoginActivity.class);
                    startActivity(intnt);
                    finish();
