package com.dealerpilothr.activities.discipline;
...
import com.dealerpilothr.api.DisciplinesAction;
...
import com.dealerpilothr.adapters.DisciplinesAdapter;
import com.dealerpilothr.api.DisciplineDeleteAction;
import com.dealerpilothr.logic.Environment;
import com.dealerpilothr.logic.UserInfo;

import java.util.ArrayList;

public class DisciplinesActivity extends BaseActivity implements DisciplinesAdapter.OnRootDisciplinesClickListener,
                                                                 DisciplinesAdapter.OnOpenDisciplinesClickListener,
                                                                 DisciplinesAdapter.OnDeleteDisciplinesClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_send_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DisciplineDeleteAction(DisciplinesActivity.this, datas.get(currentPosition).getDisciplineId()).execute();
            }
        });
    ...
    @Override
    public void onOpenDisciplinesClick(int position) {
        Intent intent = new Intent(DisciplinesActivity.this, DisciplineActivity.class);
        DisciplineData data = datas.get(position);
        intent.putExtra("name", data.getName());
        intent.putExtra("notes", data.getNotes());
    ...
    @Override
    public void onDeleteDisciplinesClick(int position) {
    ...
    @Override
    public void onFilesDisciplinesClick(int position) {
        Intent intent = new Intent(DisciplinesActivity.this, FilesActivity.class);
        DisciplineData data = datas.get(position);
        intent.putExtra("name", data.getName());
        intent.putExtra("id", data.getDisciplineId());
