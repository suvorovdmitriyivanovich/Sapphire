...
import com.dealerpilothr.adapters.TimeBanksAdapter;
...
public class TimeBanksActivity extends BaseActivity implements TimeBanksAdapter.OnRootTimeBanksClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_timebanks);
        ...
        list.setLayoutManager(new LinearLayoutManager(TimeBanksActivity.this));

        adapter = new TimeBanksAdapter(this);
        ...
        nointernet_group.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new UpdateAction(TimeBanksActivity.this);
            }
        });
    ...
    @Override
    public void onRootTimeBanksClick(int position) {
