...
public class MembersAdapter extends RecyclerView.Adapter<MembersAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        String description = "";
        description = description + Dealerpilothr.getInstance().getResources().getString(R.string.text_certified);
        ...
        description = description + "<br>" + Dealerpilothr.getInstance().getResources().getString(R.string.text_aidcertified);
        description = description + ": ";
        ...
        description = description + "<br>" + Dealerpilothr.getInstance().getResources().getString(R.string.text_healthcertified);
        description = description + ": ";
