...
public class CoursesAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(final int groupPosition, final boolean isExpanded, View convertView,
        ...
        String textCourse = "";
        textCourse = textCourse + Dealerpilothr.getInstance().getResources().getString(R.string.text_course);
        ...
        textCourse = textCourse + "<br>" + Dealerpilothr.getInstance().getResources().getString(R.string.text_quiz);
        textCourse = textCourse + ": ";
        if (allQuizPassed) {
            textCourse = textCourse + "<big><font color=#16a085>&#"+Environment.IcoOk+";</font></big> ";
        } else {
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild,
        ...
        if (!coursesData.getQuizScore().equals("")) {
            textCourse = Dealerpilothr.getInstance().getResources().getString(R.string.text_quiz_score);
