...
public class WorkplaceInspectionsAdapter extends RecyclerView.Adapter<WorkplaceInspectionsAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        description = description + Dealerpilothr.getInstance().getResources().getString(R.string.text_inspected);
        ...
        description = description + "<br>" + Dealerpilothr.getInstance().getResources().getString(R.string.text_completed);
        description = description + ": ";
