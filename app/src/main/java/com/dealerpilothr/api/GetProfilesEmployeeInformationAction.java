...
public class GetProfilesEmployeeInformationAction extends AsyncTask{

    public interface RequestProfilesEmployeeInformation {
    ...
    public GetProfilesEmployeeInformationAction(Context context) {
    ...
    protected Object doInBackground(Object... arg0) {
        ...
        String urlstring = Environment.SERVER + Environment.ProfilesEmployeeInformationURL + filter;
    ...
    protected void onPostExecute(Object o) {
        ...
        if(mContext!=null) {
            ((RequestProfilesEmployeeInformation) mContext).onRequestProfilesEmployeeInformation(resultData, profileData);
        }
    }
}
