...
public class DocumentDeleteAction extends AsyncTask{

    public interface RequestDocumentDelete {
    ...
    public DocumentDeleteAction(Context context, String id) {
    ...
    protected void onPostExecute(Object o) {
        ...
        if(mContext!=null) {
            ((RequestDocumentDelete) mContext).onRequestDocumentDelete(resultData);
        }
    }
}
