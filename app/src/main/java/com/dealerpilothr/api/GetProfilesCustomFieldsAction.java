...
public class GetProfilesCustomFieldsAction extends AsyncTask{

    public interface RequestProfilesCustomFields {
    ...
    public GetProfilesCustomFieldsAction(Context context) {
    ...
    protected Object doInBackground(Object... arg0) {
        ...
        String urlstring = Environment.SERVER + Environment.ProfilesCustomFieldsURL + filter;
    ...
    protected void onPostExecute(Object o) {
        ...
        if(mContext!=null) {
            ((RequestProfilesCustomFields) mContext).onRequestProfilesCustomFields(resultData, profileData);
        }
    }
}