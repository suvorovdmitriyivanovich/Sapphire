...
public class TimeOffRequestDeleteAction extends AsyncTask{

    public interface RequestTimeOffRequestDelete {
    ...
    public TimeOffRequestDeleteAction(Context context, String id) {
    ...
    protected Object doInBackground(Object... arg0) {
        ...
        String urlstring = Environment.SERVER + Environment.TimeOffRequestsURL + "?model%5B%5D=" + id;
    ...
    protected void onPostExecute(Object o) {
        ...
        if(mContext!=null) {
            ((RequestTimeOffRequestDelete) mContext).onRequestTimeOffRequestDelete(resultData);
        }
    }
}
