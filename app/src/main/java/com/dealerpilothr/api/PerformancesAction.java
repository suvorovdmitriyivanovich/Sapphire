...
import com.dealerpilothr.models.PerformanceData;
...
public class PerformancesAction extends AsyncTask{

    public interface RequestPerformances {
    ...
    public PerformancesAction(Context context) {
    ...
    protected Object doInBackground(Object... arg0) {
        ...
        if (responseData.getSuccess()) {
            ...
            datas = new ArrayList<PerformanceData>();
            for (int y=0; y < data.length(); y++) {
                try {
                    datas.add(new PerformanceData(data.getJSONObject(y)));
    ...
    protected void onPostExecute(Object o) {
        ...
        if(mContext!=null) {
            ((RequestPerformances) mContext).onRequestPerformances(resultData, datas);
        }
    }
}
